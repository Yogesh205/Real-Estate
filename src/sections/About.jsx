    ...
    >
      ...
      <div className="flex flex-col justify-center items-start gap-8">
        ...
        <h1
          data-aos="zoom-in"
          data-aos-delay="200"
          className="text-black text-[40px font-semibold laeding-10 dark:text-white]"
        >
        ...
        >
          ...
          eveniet tempore ipsa suscipit perferendis adipisci facilis illo
          repellendus provident asperiores!
        </p>
