    ...
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      ...
      >
        ...
        <div
          ...
          className="w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8"
        >
          {/* You can use the imported images here */}
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
            style={{ backgroundImage: `url(${area1})` }} // Corrected the syntax for dynamic image URL
          ...
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
            style={{ backgroundImage: `url(${area2})` }} // Corrected the syntax for dynamic image URL
            className="h-[400px] bg-cover bg-center rounded-xl"
          ></div>
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
            style={{ backgroundImage: `url(${area3})` }} // Corrected the syntax for dynamic image URL
            className="h-[400px] bg-cover bg-center rounded-xl"
          ></div>
        </div>
        <div
