  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      ...
      >
        ...
        <div
          id="grid-box"
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full" // Responsive grid for mobile
        >
          {property.map((item, index) => (
            ...
            >
              <div
                ...
                style={{ backgroundImage: `url(${item.images})` }} // Use item.images for dynamic image URLs
              >
                <div id="top" className="flex justify-between items-end w-full">
                  <div>
                    <button className="px-3 bg-red-600 hover:bg-white hover:text-black text-white rounded-full text-[13px]">
                      Featured
                    </button>
                  </div>
              ...
              >
                <div className="flex justify-center items-center gap-2">
                  ...
                  <div className="flex justify-center items-center gap-4">
                    <div className="p-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300">
